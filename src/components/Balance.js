...
import insr from '../assets/Insurion-logo.png';
    ...
    <div className='component exchange__transfers'>
      ...
      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={insr} className="insurion-logo" alt="Token Logo" />{symbols && symbols[0]}</p>
          <p><small>Wallet</small><br />{tokenBalances && tokenBalances[0]}</p>
          <p><small>Insured</small><br />{exchangeBalances && exchangeBalances[0]}</p>
        </div>
      ...
      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          ...
          <p><small>Insured</small><br />{exchangeBalances && exchangeBalances[1]}</p>
        </div>
